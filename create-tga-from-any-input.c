...
int main (int argc, char* argv[])
{
	...
	// number of pixels * 3 for each pixel's R G B value (no Alpha at this point)
	...
	//read_through = (char *) malloc (sizeof(char)*source_size);
	//read_through = (char *) calloc ( source_size, sizeof(char) );
	//read_through[source_size] = '\0';;
	...
	{	
		...
		fread(&read_through, 1, source_size, source);
			...
			//printf("rt rti : %d\n", read_through[read_through_index]);	
